...
class ViewBlog extends React.PureComponent {
  render() {
          ...
          <div className="do-container" style={{ paddingTop: 0 }}>
            ...
            <div className="pull-right" style={{ lineHeight: '30px' }}>
              {this.state.mode === 'view'
                ? <span onClick={() => this.setState({ mode: 'edit' })} className="action">编辑</span>
                : <span onClick={() => this.setState({ mode: 'view' })} className="action">取消</span>
              }
            </div>
          </div>
        </div>
