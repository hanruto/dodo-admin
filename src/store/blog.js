...
export default class Store extends Base {
  ...
  @action
  delete = id => {
    return axios.delete(`/articles/${id}`).then(() => this.list())
  }
  ...
  comment = comment => {
    ...
    return axios.put(`/articles/${blogId}/comment`, comment).then(blog => (this.currentBlog = blog))
  }
  ...
  @action
  deleteTag = id => {
    return axios.delete(`/articles/tags/${id}`).then(() => this.getTags())
  }
}
